    ...
    public class SoftconClientDataController : Controller
    {
        ...
        public async Task<IActionResult> FilterData([FromBody] InputData inputData)
        {
            ...
            try
            {
                ...
                var filteredData = await _SoftconClientDataDbContext.SoftconClientsData
                    .Where(data =>
                        ...
                        (inputData.Group == null || !inputData.Group.Any() || inputData.Group.Contains(data.ProjectType)) &&
